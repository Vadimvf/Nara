...
/***/ function(module, exports, __webpack_require__) {
	...
	document.addEventListener("DOMContentLoaded", function (e) {
	  ...
	  var exitTrain = document.getElementsByClassName('exit-train')[0];
	  ...
	  _game.Game.createElements(dim, healthBarCtx, totalDim, isFirstRender);
	  var gameAnimation = (0, _gameView.start)(ctx, dim);
	  ...
	  var startGame = function startGame() {
	    ...
	    (0, _gameView.setLostCall)(lostModal, restartButton, startGame);
	    if (!isFirstRender) {
	      gameAnimation = (0, _gameView.start)(ctx, dim, backgroundCtx);
	    }
	    isFirstRender = false;
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _enemyTypeA = __webpack_require__(5);
	
	var _enemyTypeB = __webpack_require__(6);
	
	var _enemyTypeC = __webpack_require__(7);
	
	var _enemyGeneration = __webpack_require__(8);
	
	var _playerShip = __webpack_require__(9);
	...
	var Game = {
	  ...
	  createElements: function createElements(dim, healthBarCtx, totalDim, isFirstRender) {
...
/***/ function(module, exports) {
	...
	var _randomColor = function _randomColor(id) {
	  if (Math.random() < .5) {
	    return COLORS.WHITE;
	  } else {
	    return COLORS.BLACK;
	...
	var _pattern = function _pattern(color) {
	  var img = void 0;
	  var pattern = void 0;
	...
	var Ship = function (_MovingObject) {
	  ...
	  _createClass(Ship, [{
	    ...
	    value: function move() {
	      ...
	      if (this.pressedKeys['D'] && this.healthBar.power >= 10) {
	    ...
	    value: function hit() {
	      ...
	      if (this.healthBar.health < -2) {
	        (0, _gameView.stop)(this.healthBar.score, true);
	      }
	    ...
	    value: function heal() {
	      ...
	      } else if (this.healthBar.power < 10) {
	        this.healthBar.power += 1;
	      }
	      this.healthBar.score += 30;
	    }
	  }, {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.stop = exports.setLostCall = exports.run = exports.start = undefined;
	...
	function start(ctx, dim, backgroundCtx) {
	...
	function stop(finalScore) {
	  ...
	  if (scoreNodeEl) {
	    var newScores = document.createElement('ul');
	    var temp = newScores;
	    ...
	    lostModal.children[0].insertAdjacentHTML('afterbegin', '<ul>\n       <li><h1 class="final-score">' + finalScore + '</h1></li>\n       <li><h3>Your Top 5:  ' + scores + '</h3></li>\n       </ul>');
	...
	exports.start = start;
	exports.run = run;
	exports.setLostCall = setLostCall;
	exports.stop = stop;
	...
	var HealthBar = function () {
	  ...
	  _createClass(HealthBar, [{
	    ...
	    value: function draw() {
	      ...
	      //power
	      this.ctx.fillRect(this.pos[0] + 850, this.pos[1], this.width, this.power * -50);
